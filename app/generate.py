...
async def save_base_img(file):
    ...
    print('activate2')
    download = request.urlopen(file).read() # <-- 오류코드 외부URL은 s괜찮은데 내부로 요청하면 멈춤
    print('activate3')
...
async def get_prompt_img2img(keyword: str = Form(), W: str = Form(), H: str = Form(),
    ...
    return 'http://192.168.0.113:3333/generated_img2img'
...
async def get_image():
    url = ['http://192.168.0.113:3333/generated_img2img/1', 
           'http://192.168.0.113:3333/generated_img2img/2', 
           'http://192.168.0.113:3333/generated_img2img/3', 
           'http://192.168.0.113:3333/generated_img2img/4']
    return url
